...
export default function Salate({productItems}:{productItems:Item[]}) {
...
export async function getServerSideProps() {
    ...
    const res = await fetch(`${apiUrl}/api/salaties?pagination[start]=0&pagination[limit]=200&populate=*`, {
        headers: {
