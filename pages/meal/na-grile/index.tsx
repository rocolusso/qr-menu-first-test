...
export default function NaGrile({productItems}:{productItems:Item[]}) {
...
export async function getStaticProps() {
    ...
    const res = await fetch(`${apiUrl}/api/myaso-na-griles?pagination[start]=0&pagination[limit]=200&populate=*`, {
        headers: {
