...
export default function Bruschette({productItems}:{productItems:Item[]}) {
...
export async function getServerSideProps() {
    ...
    const res = await fetch(`${apiUrl}/api/brusketies?pagination[start]=0&pagination[limit]=200&populate=*`, {
        headers: {
