...
export default function Garniry({productItems}:{productItems:Item[]}) {
...
export async function getStaticProps() {
    ...
    const res = await fetch(`${apiUrl}/api/garniries?pagination[start]=0&pagination[limit]=200&populate=*`, {
        headers: {
