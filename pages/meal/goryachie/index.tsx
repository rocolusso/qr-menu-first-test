...
export default function Goryachie({productItems}:{productItems:Item[]}) {
    ...
    return (
        <div className={'relative'}>
            ...
            <div className={'pt-24 mx-auto flex justify-center items-center max-w-[600px]'}>
                ...
                <div className={`grid grid-cols-1 gap-3 p-2 w-full ${items?.length > 0 ? 'pb-20':''}`}>
                    {
...
export async function getServerSideProps() {
    ...
    const res = await fetch(`${apiUrl}/api/goryachie-blyudas?pagination[start]=0&pagination[limit]=200&populate=*`, {
        headers: {
